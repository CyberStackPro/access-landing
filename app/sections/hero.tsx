      ...
      <div className="container relative mx-auto px-4 pt-20 pb-16 md:pt-32 md:pb-24">
        <div className="flex flex-col items-center gap-16">
          <div className="relative w-full max-w-4xl">
            {/* Ripple positioned behind the content */}
          ...
          <motion.div
            ...
            className="w-full "
          >
            <div className="relative mx-auto max-w-7xl  rounded-[32px] border border-border bg-neutral-100 p-2 backdrop-blur-lg dark:border-neutral-700 dark:bg-neutral-800/50 md:p-4">
